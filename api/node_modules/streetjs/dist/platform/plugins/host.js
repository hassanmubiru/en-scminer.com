 ...
 */
const PLUGIN_PERMISSION_VALUES = ['middleware', 'events', 'net', 'fs', 'db', 'secrets'];
const _permValuesGuard = true;
const _permCoverageGuard = true;
...
const ALL_PERMS = [...PLUGIN_PERMISSION_VALUES];
/**
...
export class PluginHost {
    ...
    register(plugin, manifest) {
        ...
        if (!parsed.success) {
            throw new PluginManifestError(`Plugin "${plugin.name}" has an invalid manifest: ${parsed.error.message}`);
        }
