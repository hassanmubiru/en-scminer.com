...
export declare const SENDGRID_DEFAULT_TIMEOUT_MS = 30000;
 ...
 */
export declare function verifySendGridWebhook(publicKey: string, rawBody: string | Buffer, signature: string, timestamp: string): boolean;
