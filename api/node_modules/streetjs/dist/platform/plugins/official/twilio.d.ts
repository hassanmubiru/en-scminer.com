...
export declare const TWILIO_DEFAULT_TIMEOUT_MS = 30000;
 ...
 */
export declare function verifyTwilioSignature(authToken: string, url: string, params: Record<string, string>, signature: string): boolean;
