...
function generateKubernetes(config) {
    ...
    return [
        ...
        `#`,
        `# BEFORE applying: create the Secret this Deployment pulls via envFrom.`,
        `# The app runs with NODE_ENV=production and fails fast without these.`,
        ...
        `# (add PG_HOST/PG_USER/PG_PASSWORD/PG_DATABASE too when using PostgreSQL)`,
        `# Then: kubectl apply -f deploy/deployment.yaml`,
 ...
 */
function k8sEnvFromSection(config, indent) {
