...
import { type Clock, type RateLimitStore } from '@streetjs/store';
 ...
 * ```
 */
export declare function rateLimit(opts: ScopedRateLimitOptions): MiddlewareFn;
/**
 * Minimal Redis client surface needed by {@link RedisRateLimitStore}. Satisfied
 * by the core `RedisClient` and by any client exposing a raw `command(args)`
 * method.
 */
