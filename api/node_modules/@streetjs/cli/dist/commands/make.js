...
export class MakeCommand {
    ...
    async scaffold(ctx, spec) {
        ...
        if (!MAKE_NAME_PATTERN.test(name)) {
            console.error(`[street] Invalid name "${name}". Name must match ${MAKE_NAME_PATTERN.source} (letters and digits, starting with a letter).`);
