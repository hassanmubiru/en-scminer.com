...
export class InfoCommand {
    async execute(ctx) {
        ...
        const streetVersion = await this.readPackageVersion(resolve(ctx.cwd, 'node_modules', 'streetjs', 'package.json')) ?? await this.readPackageVersion(resolve(ctx.cwd, 'node_modules', '@streetjs', 'core', 'package.json')) ?? await this.readPackageVersion(resolve(ctx.cwd, '..', 'core', 'package.json')) ?? '(unknown)';
